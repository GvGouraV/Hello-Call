                ...
                <Box sx={{ flexGrow: 1, backgroundColor: "white" }}>
                    <Grid container alignItems="left" spacing={2} sx={{ pt: 2, pl: 7, pb: 1 }}>
                        <Grid item xs={3} sm={3} md={1} >
                            <Button className="bg-light" sx={{ color: "#6d1f8c", fontSize: "11px" }} onClick={() =>this.handleClick(0)}>Call Logs</Button>

                        </Grid>
                        <Grid item xs={3} md={1}>
                             <Button className=" "sx={ {color: "gray", fontSize: "11px" } }onClick={() =>this.handleClick(1)}>SMS Logs</Button>
                        </Grid>
                        <Grid item xs={0} md={7}>
